                    ...
                    <div class="col-md-6">
                        <div class="list-single-main-item fl-wrap">
                            ...
                            <div class="list-author-widget-contacts">
                                <ul>
                                    <li><span><i class="fa fa-phone"></i> @lang('corals-directory-basic::labels.template.contact.phone'):</span>
                                        <a
                                                href="#">{{ \Settings::get('contact_mobile','+970599593301') }}</a>
                                    </li>
                                    <li><span><i class="fa fa-envelope-o"></i> @lang('corals-directory-basic::labels.template.contact.email') :</span>
                                        <a
