                ...
                <div class="container">
                    <div class="list-single-header-item">
                        ...
                        @if(\Settings::get('directory_rating_enable',true))
                            @include('partials.components.rating',['rating'=> $listing->averageRating(1)[0],'rating_count'=>optional($listing->countRating())[0] ])
                        @endif
                    </div>
            ...
            <div class="main-register fl-wrap">
                ...
                <div id="tabs-container">
                    <div class="custom-form">
                        {!! CoralsForm::openForm(null,['url' => url('directory/user/'.$listing->hashed_id.'/claim'),'method'=>'POST', 'class'=>'ajax-form','id'=>'claim-form','data-page_action'=>"closeModal", "files"=>true]) !!}
