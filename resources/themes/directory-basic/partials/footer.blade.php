                ...
                <div class="footer-widget fl-wrap">
                    ...
                    <div class="footer-contacts-widget fl-wrap">
                        ...
                        <ul class="footer-contacts fl-wrap">
                            <li><span><i class="fa fa-envelope-o"></i>@lang('corals-directory-basic::labels.footer.mail')</span><a href="mailto:{{ \Settings::get('contact_form_email','support@example.com') }}"
                                                                                                                                   target="_blank">{{ \Settings::get('contact_form_email','support@example.com') }}</a>
                            </li>
